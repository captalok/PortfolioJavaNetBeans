 ...
 * @author alk_6
 */
public class PositiveValueCellRenderer extends DefaultTableCellRenderer {

    private int targetColumn;

    public PositiveValueCellRenderer(int targetColumn) {
        ...
        if (column == targetColumn) {
            try {
                ...
                if (numericValue > 0) {
                    ...
                    cell.setForeground(Color.BLACK); // Default color for zero or negative values
                }
